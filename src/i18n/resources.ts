 ...
 */
export const NAMESPACES = ["common", "catalog", "cart", "checkout"] as const;
...
export const resources: Record<SupportedLocale, Record<Namespace, ResourceTree>> = {
  "en-US": { common: enUSCommon, catalog: enUSCatalog, cart: enUSCart, checkout: enUSCheckout },
  "en-GB": { common: enGBCommon, catalog: enGBCatalog, cart: enGBCart, checkout: enGBCheckout },
  "fr-FR": { common: frFRCommon, catalog: frFRCatalog, cart: frFRCart, checkout: frFRCheckout },
};
