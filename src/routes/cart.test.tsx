...
describe('/cart route', () => {
  ...
  it('adds two SKUs, updates quantity, removes one, asserts correct subtotal', async () => {
    addToCart({ skuId: 'fj-s-black', productId: '1', productName: 'Faker Jersey', variant: 'S / Black', price: 59.99 })
    addToCart({ skuId: 'fj-m-white', productId: '1', productName: 'Faker Jersey', variant: 'M / White', price: 62.99 })
