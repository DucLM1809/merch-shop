...
const twoOrders: Order[] = [
  {
    ...
    total: 119.98,
    shipping: {
      fullName: 'Faker', email: 'faker@t1.gg',
      line1: '1 T1 Way', city: 'Seoul', state: 'Seoul', postalCode: '00000', country: 'KR',
    },
    lines: [
      { skuId: 'fj-s-black', productName: 'Faker Jersey', variant: 'S / Black', price: 59.99, quantity: 2 },
    ],
  },
  {
    id: 'ord-002',
    ...
    lines: [
      { skuId: 'lol-hoodie-m', productName: 'League of Legends Hoodie', variant: 'M', price: 79.99, quantity: 1 },
    ],
  },
]
